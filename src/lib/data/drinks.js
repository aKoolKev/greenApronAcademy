export const holidayDrinks_2025_hot = [
    ...
    },
    {
        ...
        isHot: true,
        steps: ["espresso", "syrup", "sauce", "milk", "whippedCream", "topping"],
        espresso: "Default",
    ...
    },
    {
        ...
        isHot: true,
        steps: ["syrup", "sauce", "milk", "whippedCream", "topping"],
        syrup: "Peppermint",
        syrupAmount: [2,3,4,5],
        sauce: "Mocha",
        sauceAmount: [2,3,4,5],
    ...
    },
    {
        ...
        isHot: true,
        steps: ['concentrate', 'syrup', 'milk', 'milkAmount', 'hotWater', 'topping'],
        concentrate: "Chai",
